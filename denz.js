...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'MATHEUS\n'
            + 'ORG:Owner CAFE 𝙱𝙾𝚃;\n'
            + 'TEL;type=CELL;type=VOICE;waid=557191698042:+55 71 9169-8042\n'
            + 'END:VCARD'
...
prefix = "!"
name = "MATHEUS"
rdaftar = "OBRIGADO POR SE REGISTAR PARA SER UM USUÁRIO DO MATHEUS 😁"
...
memberLimit = 2
ban = []
premium = ["557191698042@s.whatsapp.net","994406544979@s.whatsapp.net","994408882967@s.whatsapp.net"]
...
ᴅɪɢɪᴛᴇ ${prefix}daftar ᴘᴀʀᴀ ᴄᴏᴍᴇᴄᴀʀ ᴀ ᴜsᴀʀ  ʙᴏᴛ`
	...
	denz.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["557191698042@s.whatsapp.net","994406544979@s.whatsapp.net","994408882967@s.whatsapp.net"] // owner number ubah aja
