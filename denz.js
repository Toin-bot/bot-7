...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'Sony Vegaskk\n'
            + 'ORG:Owner Vegas bot;\n'
            + 'TEL;type=CELL;type=VOICE;waid=55738104096:+55 73 8104-4096\n'
            + 'END:VCARD'
...
prefix = "*"
name = "Sony"
rdaftar = "OBRIGADO POR SE REGISTAR PARA SER UM USUÁRIO DO Sonyk 😁"
rmenu = "Oi amigo Tempestbot 👋🏻 NÃO SE ESQUEÇA NAO PAGUE POR BOTS:)"
botinfo = "PARA BOTS CONVIDADOS, TODOS BOTS TERMUX SAO INDONÉSIO NENHUM BR CRIA SÓ EDITA:)"
limitt = 999999999
memberLimit = 4
ban = []
premium = ["557381044096@s.whatsapp.net","994406544979@s.whatsapp.net","557191698042@s.whatsapp.net"]
...
async function starts() {
	...
	denz.on('connecting', () => {
		start('2', 'Conectar querida ❤️...')
	})
	denz.on('open', () => {
		success('2', 'Querida conectada ❤️')
	})
	...
	denz.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				...
				success: '*sᴜᴄᴇssᴏ...*',
				error: {
					stick: '*𝙵𝙰𝙻𝙷𝙾𝚄,𝙾𝙲𝙾𝚁𝚁𝙴𝚄 𝚄𝙼 𝙴𝚁𝚁𝙾 𝙰𝙾 𝙲𝙾𝙽𝚅𝙴𝚁𝚃𝙴𝚁 𝙰 𝙸𝙼𝙰𝙶𝙴𝙼 𝙴𝙼 𝚂𝚃𝙸𝙲𝙺𝙴𝚁*',
					Iv: '*𝙳𝙴𝚂𝙲𝚄𝙻𝙿𝙴 𝙻𝙸𝙽𝙳𝙾𝚁,𝙻𝙸𝙽𝙺 𝙸𝙽𝚅𝙰𝙻𝙸𝙳𝙾𝚁!*'
				},
				only: {
					group: '*𝙳𝙴𝚂𝙲𝚄𝙻𝙿𝙴, 𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾 𝙿𝙾𝙳𝙴 𝚂𝙴𝚁 𝚄𝚂𝙰𝙳𝙾 𝙴𝙼 𝙶𝚁𝚄𝙿𝙾!*',
					benned: '*𝙳𝙴𝚂𝙲𝚄𝙻𝙿𝙴 𝚂𝙴𝚄 𝙽𝚄𝙼𝙴𝚁𝙾 𝙴𝚂𝚃𝙰 𝙿𝚁𝙾𝙸𝙱𝙸𝙳𝙾, 𝙿𝙾𝚁 𝙵𝙰𝚅𝙾𝚁, 𝙴𝙽𝚃𝚁𝙴 𝙴𝙼 𝙲𝙾𝙽𝚃𝙰𝚃𝙾 𝙲𝙾𝙼 𝙾 𝙿𝚁𝙾𝙿𝚁𝙸𝙴𝚃𝙰𝚁𝙸𝙾 𝙿𝙰𝚁𝙰 𝙰𝙱𝚁𝙸𝚁 𝚂𝙴𝚄 𝙿𝚁𝙾𝙸𝙱𝙸𝙳𝙾*',
			...
			const ownerNumber = ["557381044096@s.whatsapp.net","994406544979@s.whatsapp.net","557191698042@s.whatsapp.net"] // owner number ubah aja
		...
		setTimeout( () => {
		reply(`desculpe, bot tempest deixa o grupo em breve *${groupMetadata.subject}*`)
		}, 0)
		}
...
denz.sendMessage(from, hasil, text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "ketik #menu kak", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
		...
		if (isGroupAdmins) return reply(`*${pushname2}* é um administrador de grupo Você não será expulso`)
		denz.updatePresence(from, Presence.composing)
		...
		setTimeout( () => {
		reply(`*_「 𝑃𝑎𝑙𝑎𝑣𝑟𝑎 𝑜𝑓𝑒𝑛𝑠𝑖𝑣𝑎 𝐷𝑒𝑡𝑒𝑐𝑡𝑎𝑑𝑎」_*\n𝐷𝑒𝑠𝑐𝑢𝑙𝑝𝑒 *${pushname2}* Você fala sujo! Você será imediatamente expulso do grupo *${groupMetadata.subject}*`)
		}, 0)
		}
...
╓───「 *_ʙᴏᴛ ɪɴғᴏ_* 」
║❏ 𝐂𝐑𝐈𝐀𝐃𝐎𝐑: 𝑆𝑂𝑁𝑌 𝑉𝐸𝐺𝐴𝑆
║❏ 𝐄𝐃𝐈𝐓𝐀𝐃𝐎 𝐏𝐎𝐑: 𝑇𝐼𝑂 𝐶𝐴𝐹𝐸 
║❏ 𝐏𝐑𝐄𝐅𝐈𝐗: ${prefix}
║❏ 𝐔𝐒𝐔𝐀𝐑𝐈𝐎 𝐑𝐄𝐆𝐈𝐒𝐓𝐑𝐀𝐃𝐎: ${user.length}
╙───々
╓───「 *_𝐔𝐒𝐔𝐀𝐑𝐈𝐎 𝐈𝐍𝐅𝐎_* 」
║❏ 𝐍𝐎𝐌𝐄: ${pushname2}
║❏ 𝐈𝐋𝐈𝐌𝐈𝐓𝐀𝐃𝐎: ${limitt}
...
case 'igpost': 				
		...
		case 'fakeaddress': 
				...
				teks = `➸ *Nome* : ${anu.result.name}\n*➸ Aniversário :* ${anu.result.birthday}\n*➸ Endereço :* ${anu.result.address}\n*➸ Cidade :* ${anu.result.city}\n*➸ Região :* ${anu.result.region}\n*➸ País :* ${anu.result.country}\n*➸ Código postal :* ${anu.result.zip}\n*➸ Número de telefone :* ${anu.result.phone_number}\n*➸ Nome de usuário :* ${anu.result.username}\n*➸ Senha :* ${anu.result.password}\n*➸ Email :* ${anu.result.email}`
		...
		case 'kusonime': 
				...
				hasil = `*Título:* : ${anu.result.title}\n*Título Jp* : ${anu.result.title_jp}\n*Gênero* : ${anu.result.genre}\n*Estação* : ${anu.result.season}\n*Produtor* : ${anu.result.producer}\n*Modelo* : ${anu.result.type}\n*Episódio Total* : ${anu.result.total_episode}\n*Avaliação* : ${anu.result.score}\n*Duração* : ${anu.result.duration}\n*Lançado em* : ${anu.result.released_on}\n*Descrição* : ${anu.result.description}`
				denz.sendMessage(from, buffer, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "@denssptraa", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('dnsnew.jpg')} } }, caption: hasil})
				break
		case 'cekresijne': 
				if (args.length < 1) return reply(`Qual é o res, mano??`)
				reply(`[❕] Carregando`)
				anu = await fetchJson(`https://onlydevcity.herokuapp.com/api/searchresi?courier=jne&awb=${body.slice(11)}&apikey=onlyonedeveloper`)
				hasil = `*codificador morreu de fome:* : ${anu.result.data.summary.awb}\n*Correio* : ${anu.result.data.summary.courier}\n*Serviço* : ${anu.result.data.summary.service}\n*Status* : ${anu.result.data.summary.status}\n*Encontro* : ${anu.result.data.summary.date}\n*Desc* : ${anu.result.data.summary.desc}\n*Preço* : ${anu.result.data.summary.amount}\n*Peso de mercadorias* : ${anu.result.data.summary.weight}\n*Origem* : ${anu.result.data.detail.origin}\n*Destino* : ${anu.result.data.detail.destination}\n*Remetente* : ${anu.result.data.detail.shipper}\n*Receptor* : ${anu.result.data.detail.receiver}`
				...
				break
				case 'randomwp': 
				reply(`[❕] credor gaypop,espera ai mn`)
         ...
         case 'lirik':
                ...
                if (args.length < 1) return reply(`Yang mau direport apaan? Contoh: #report fitur #hentai error`)
                     ...
                     const pesan = body.slice(8)
                      if (pesan.length > 300) return denz.sendMessage(from, 'Desculpe, o texto é muito longo, máximo 300 Teks', text, {quoted: mek})
                ...
                if (args.length < 1) return reply(`Mau request apa? Contoh: #request fitur anime`)
                    ...
                    denz.sendMessage('6285866295942@s.whatsapp.net', options, text, {quoted: mek})
                    reply('Solicitações falsas / main2 não serão respondidas BOT, Solicitações falsas / main2 não serão respondidas.')
                    break
				case 'memeindo':
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
...
break
				...
				if (isLimit(sender)) return reply(limitend(pushname2))
				reply(mess.wait)
					if (args.length < 1) return reply('citações??')
					tels = body.slice(7)
               ...
               if (isLimit(sender)) return reply(limitend(pushname2))
                ...
                if (isLimit(sender)) return reply(limitend(pushname2))
					...
					denz.sendMessage(from, buff, image, { quoted: mek , caption: 'Miau🐈'})
					await limitAdd(sender) 
					break 
...
// akhir fitur anime
			...
			case 'hekerbucin':
				...
				case 'tiktokstalk':
					...
					if (isLimit(sender)) return reply(limitend(pushname2))
					if (args.length < 1) return denz.sendMessage(from, 'Onde está o nome de usuário?', text, {quoted: mek})
